...
@Component({
  selector: 'app-notes-manager-modal',
  templateUrl: './notes-manager-modal.component.html',
  styleUrls: ['./notes-manager-modal.component.scss']
})
export class NotesManagerModalComponent implements OnInit, OnDestroy {
